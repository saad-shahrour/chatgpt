    ...
    <div className='flex justify-center items-center py-6 px-4 md:px-28 md:py-5' style={{direction: "rtl"}}>
        <div>
            ...
            <p className='font-bold text-md md:text-lg'>
                <br/>
                نحن مفيد AI، نفتخر بتقديم أفضل وأول خدمة للدردشة على منصة الواتساب في الوطن العربي. باستخدام تقنية GPT-3.5 turbo، نوفر لك تجربة دردشة فائقة الجودة ومتقدمة.
                <br/>
                <br/>
