    ...
    return (
      <div className='py-10 p-6 md:px-28 md:py-5'>
        ...
        <div className='flex justify-center items-center'>
          <button className='m-auto border border-lightBlue text-lightBlue my-16 text-md md:text-lg font-bold rounded-lg pt-3 pb-4 px-6 outline-none hover:opacity-75 mx-2'>
